...
foreach (array('theme-data.php', 'images.php', 'order-form.php', 'shortcodes.php', 'compro.php', 'berita.php') as ${{PREFIX}}_file) {
...
if (!function_exists('{{PREFIX}}_body_class')) {
    ...
    function {{PREFIX}}_body_class($classes)
    {
        ...
        if ({{PREFIX}}_jenis_berita()) {
            // Portal berita (Paket Portal Berita Custom, lihat inc/berita.php).
            $classes[] = '{{PREFIX}}--berita';
        }
